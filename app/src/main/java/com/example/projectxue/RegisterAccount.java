        ...
        auth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    UtilitiesX.UID=FirebaseAuth.getInstance().getUid();
                    DatabaseReference db= FirebaseDatabase.getInstance().getReference("Users").child(UtilitiesX.UID);
                    basicUserProfile.setBasicProp();
                    basicUserProfile.setUser();
                    basicUserProfile.setUID(UtilitiesX.UID);


                   db.setValue(basicUserProfile.H);
